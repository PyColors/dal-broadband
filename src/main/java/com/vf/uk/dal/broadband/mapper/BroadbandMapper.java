...
public interface BroadbandMapper {
	...
	//@Mapping(target="serviceReference.serviceLines.lineTreatments", source="servicePoint.serviceReference.serviceLinesList.lineTreatmentList")
	//@Mapping(target="serviceReference.serviceLines.serviceLines", source="servicePoint.serviceReference.serviceLinesList.serviceLineList")
	//@Mapping(target="serviceReference.serviceLines.serviceLines.serviceLineList.serviceLineTreatments", source="servicePoint.serviceReference.serviceLinesList.serviceLineList.serviceLineTreatmentList")
	//@Mapping(target="serviceReference.serviceLines.serviceLines.serviceLineList.serviceLineTreatments.simValue", source="servicePoint.serviceReference.serviceLinesList.serviceLineList.serviceLineTreatmentList.sIM2Value")
