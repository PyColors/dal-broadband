...
public class ServiceLines implements Serializable {
	...
	private static final String LINETREATMENT_LIST = "lineTreatments";

	/** The Constant SERVICELINELIST. */
	private static final String SERVICELINE_LIST = "serviceLines";
	...
	private List<LineTreatment> lineTreatments = new ArrayList<>();

	/** The service line list. */
	@JsonProperty(SERVICELINE_LIST)
	private List<ServieLine> serviceLines = new ArrayList<>();
