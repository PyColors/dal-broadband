...
public class Hardware {
	...
	/**
	 * 
	 * @param deviceBriefDescriptionItem
	 * @return
	 */
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.action, hardware.action) && Objects.equals(this.attributes, hardware.attributes)
				...
				&& Objects.equals(this.isChanged, hardware.isChanged) && Objects.equals(this.make, hardware.make)
				&& Objects.equals(this.memorySize, hardware.memorySize)
				&& Objects.equals(this.merchandisingMedia, hardware.merchandisingMedia)
				&& Objects.equals(this.model, hardware.model) && Objects.equals(this.name, hardware.name)
	...
	@Override
	public int hashCode() {
		return Objects.hash(action, attributes, boxPrice, description, deviceBriefDescription, deviceColor,
				displayDescription, displayName, displayOrder, freeGift, groupType, isChanged, make, memorySize,
				merchandisingMedia, model, name, packageLineId, priceDetails, productClass, showInSummary, skuId);
	}
