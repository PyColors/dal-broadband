...
public class JourneyState {
	...
	/**
	 * To be sent by basket API when the current journey is moved to COMPLETED.
	 * The basket Id would not be sent for an INPROGRESS state update
	 * 
	 * @return basketId
	 **/
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.name, journeyState.name) && Objects.equals(this.state, journeyState.state)
